...
function App() {
    ...
    return (
        <main className='m-0 h-screen w-screen flex flex-col-reverse justify-between items-center lg:flex-row lg:justify-start lg:items-start bg-background text-foreground'>
            ...
            {
                user ?
                    <nav className="fixed bottom-0 left-0 right-0 z-50 flex flex-col items-end gap-3 m-2 rounded-4xl lg:static lg:h-full lg:max-w-72 lg:m-0 lg:p-3 lg:flex-1 lg:items-start lg:bg-background-tertiary ">
                        <Navbar />
                    </nav>
                    :
                    null
